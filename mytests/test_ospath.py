...
#当前文件
print type(__file__),__file__   #<type 'str'> E:\eclipse-workspace\awesome\src\mytest\ex_os.py  
#当前文件的绝对路径
print os.path.abspath(__file__)  #E:\eclipse-workspace\awesome\src\mytest\ex_os.py
#当前文件所在目录
print os.path.dirname(os.path.abspath(__file__)) #E:\eclipse-workspace\awesome\src\mytest

print os.sep
print os.getcwd()
print os.listdir(os.getcwd()) #返回文件名(带后缀)列表
